...
class UserRouter {
    ...
    private initializeRouter(){
        ...
        this.router.get('/userCheck', userScret,this.userController.userCheck);
        this.router.get('/userProfile', userScret,this.userController.userProfile);
        this.router.put('/userDisable', userScret,this.userController.userDisable);
