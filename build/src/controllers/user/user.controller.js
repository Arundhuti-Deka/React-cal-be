...
class UserController {
    constructor() {
        ...
        this.authenticate = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield user_model_1.default.findOne({ $or: [{ email: req.body.email }, { phoneNo: req.body.phoneNo }], isActive: true });
                if (user) {
        ...
        this.userCheck = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.userDisable = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield user_model_1.default.findById(req['tokenId']);
                if (user) {
                    let userUpdate = yield user_model_1.default.updateOne({ _id: req['tokenId'] }, { $set: { isActive: false } }, { new: true });
                    if (userUpdate) {
