...
class AdminController {
    constructor() {
        ...
        this.authenticate = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield admin_model_1.default.findOne({ email: req.body.email, isAdmin: true });
                if (user) {
        ...
        this.adminProfile = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield admin_model_1.default.findById(req['tokenId']);
                if (user) {
        ...
        this.userEnable = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield admin_model_1.default.findById(req['tokenId']);
                if (user) {
                    let userEmail = yield user_model_1.default.findOne({ email: req.body.email, isActive: false });
                    if (userEmail) {
                        let user = yield user_model_1.default.updateOne({ email: req.body.email }, { $set: { isActive: req.body.isActive } }, { new: true });
                        if (user) {
