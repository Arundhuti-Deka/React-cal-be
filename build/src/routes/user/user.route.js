...
class UserRouter {
    ...
    initializeRouter() {
        ...
        this.router.get('/userCheck', user_verify_1.default, this.userController.userCheck);
        this.router.get('/userProfile', user_verify_1.default, this.userController.userProfile);
        this.router.put('/userDisable', user_verify_1.default, this.userController.userDisable);
