...
class OrderRouter {
    ...
    initializeRoutes() {
        ...
        this.router.post('/addCart', user_verify_1.default, this.OrderController.addCart);
        this.router.get('/getUserCart', user_verify_1.default, this.OrderController.getUserCart);
        this.router.put('/updateCart/:_id', user_verify_1.default, this.OrderController.updateCart);
        this.router.delete('/deleteCart', user_verify_1.default, this.OrderController.deleteCartById);
    }
}
